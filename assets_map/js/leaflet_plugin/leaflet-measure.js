!function (e) {
    ...
    function s(e) {
        ...
        return {
            lastCoord: {dd: {x: t.lng, y: t.lat}, dms: {x: i(t.lng, "Đ", "T"), y: i(t.lat, "B", "N")}},
            length: s,
            area: a
        }
    }
    ...
    e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure distances and areas">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h5>Đo khoảng cách và diện tích</h5> <ul class=tasks> <a href=# class="js-start start">Tạo đối tượng</a> </ul> </div> <div class=js-measuringprompt> <h5>Đo khoảng cách và diện tích</h5> <p class=js-starthelp>Bắt đầu đo đạc</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancel</a></li> <li><a href=# class="js-finish finish">Kết thúc đo đạc</a></li> </ul> </div> </div> '
}, function (e, t, r) {
    e.exports = '<div class=group> <p class="lastpoint heading">Điểm cuối cùng</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Khoảng cách</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Diện tích</span> {{ model.areaDisplay }}</p> </div> <% } %> '
}, function (e, t, r) {
    e.exports = '<h5>Tọa độ</h5> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Vị trí giữa</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Xóa</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h5>Độ dài đường</h5> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Vị trí giữa đường</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Xóa</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h5>Diện tích vùng</h5> <p>{{ model.areaDisplay }}</p> <p><b>Chu vi </b>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Vị trí giữa vùng</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Xóa</a></li> </ul> '
}]);
