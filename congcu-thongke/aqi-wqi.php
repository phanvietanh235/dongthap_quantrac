...
<body>
                                    ...
                                    <div class="tab-content" id="aboutTabsContent">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="developers">
                                            <div class="pdd-horizon-15 pdd-vertical-20">
                                                ...
                                                <p>
                                                    <i class="icon-location4" style="font-size: 16px; margin-top: -2px"></i>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4 class="card-title">
                                                    <b>
                                                        <i class="fa fa-leaf pdd-right-5"></i>
                                                        Đánh giá chất lượng môi trường AQI - WQI
                                                    </b>
                                                </h4>
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <input type="text" id="date-rangeAW" class="form-control"
                                                                   placeholder="Date range picker" style="height: 1.85rem" />
                                                        </div>
                                                        <div class="col-md-6" style="margin-top: -5px">
                                                            <div class="radio radio-inline">
                                                                <input type="radio" name="form-5" id="wqi-option" checked>
                                                                <label for="wqi-option">Chất lượng môi trường nước WQI</label>
                                                            </div>
                                                            <div class="radio radio-inline">
                                                                <input type="radio" name="form-5" id="aqi-option">
                                                                <label for="aqi-option">Chất lượng môi trường không khí AQI</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <a href="#" class="btn btn-info btn-sm" id="WQI-AQI-result-btn">
                                                    ...
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        ...
                                                        <!-- <li class="nav-item">
                                                            <a href="#nav-tabs-2" class="nav-link" role="tab" data-toggle="tab">
                                                                <i class="ti-menu-alt pdd-right-10"></i> Chú thích
                                                            </a>
                                                        </li> -->
                                                    </ul>
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade in active" id="nav-tabs-1">
                                                            <div class="pdd-horizon-15 pdd-vertical-20">
                                                                <div class="table-overflow">
                                                                    <table class="table table-lg table-hover" id="aqiwqi_table">
                                                                        <!-- Dom data WQI/AQI -->
                                                                    </table>
                                                                </div>
                                                            </div>
    ...
    <script src="js/aqi-wqi.js"></script>
