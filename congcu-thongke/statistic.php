...
<body>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h4 class="card-title">
                                                    <b>
                                                        <i class="ti-bar-chart-alt pdd-right-5"></i>
                                                        Thống kê quan trắc môi trường
                                                    </b>
                                                </h4>
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <select class="form-control" id="congtrinh">
                                                                <!-- DOM from DB -->
                                                            </select>
                                                        </div>
                                                        <!-- <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control" id="quychuan">
                                                                <!-- DOM from DB -->
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-md-6">
                                                            <label style="margin-top: 7px" class="control-label">
                                                                <b>Trạm/Điểm/Giếng khai thác</b>&nbsp;
                                                                <i class="fa fa-refresh"></i>
                                                            </label>
                                                            <select class="form-control" id="tramqt" multiple="multiple" style="width: 100%">
                                                                <!-- DOM from DB
                                                                <option value="none" disabled>-- Lựa chọn loại trạm --</option> -->
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label style="margin-top: 7px" class="control-label">
                                                            ...
                                                            <select class="form-control" id="para" multiple="multiple" style="width: 100%">
                                                                <!-- DOM from DB -->
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <!-- <div class="col-md-3">
                                                            <select class="form-control" id="dis-time">
                                                                <option value="none">-- Lựa chọn thời gian hiển thị --</option>
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" id="rangedateStatistic" class="form-control"
                                                                   placeholder="Date range picker" style="height: 1.85rem" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="row">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_statistic">
                                                                <i class="ti-search pdd-right-5"></i>
                                                                <span>Tìm kiếm</span>
                                                            </a>
                                                                <div class="mrg-left-20 loader-stats" style="display: none"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist" id="tab_statistic">
                                                        <li class="nav-item">
                                                        ...
                                                        <!-- <li class="nav-item">
                                                            <a href="#nav-tabs-2" class="nav-link" role="tab" data-toggle="tab">
                                                                <i class="icon-calculator2 pdd-right-10"></i> Min/Max/Trung bình
                                                            </a>
                                                        </li> -->
                                                        <li class="nav-item">
                                                            <a href="#nav-tabs-3" class="nav-link" role="tab" data-toggle="tab">
                                                                <i class="icon-chart pdd-right-10"></i> Biểu đồ
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content">
                                                        <div role="tabpanel" class="tab-pane fade in active" id="nav-tabs-1">
                                                            <div class="pdd-horizon-15 pdd-vertical-20">
                                                                <div class="table-overflow">
                                                                    <table id="statistic_table" class="table table-sm table-hover table-bordered table-responsive-sm">
                                                        ...
                                                        <div role="tabpanel" class="tab-pane fade" id="nav-tabs-3">
                                                            <div class="chart-render pdd-horizon-15 pdd-vertical-20">
                                                                <!-- DOM Chart -->
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script src="js/statistic-option.js"></script>
