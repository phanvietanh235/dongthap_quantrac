                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>
                                                <i class="red ti-alert"></i>
                                                <b class="red">Danh sách vượt ngưỡng</b>
                                            </b>
                                        </h4>
                                        <div class="table-overflow">
                                            <table id="table_threshold" class="table table-striped table-bordered table-condensed">
                                                <thead>
                                                    <tr class="bg-info" role="row" style="color: #000">
                                                        <th scope="col" class="bg-danger fixed-header"></th>
                                                        <th scope="col" class="bg-danger text-white fixed-header">Tên trạm</th>
                                                        <th scope="col" class="bg-danger text-white fixed-header">Loại hình</th>
                                                        <th scope="col" class="bg-danger text-white fixed-header">Loại trạm</th>
                                                        <th scope="col" class="bg-danger text-white fixed-header">Địa điểm</th>
                                                    </tr>
                                                </thead>
