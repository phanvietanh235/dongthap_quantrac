...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                            ...
                                            <div class="col-md-12">
                                                <form class="form-horizontal mrg-top-10 pdd-right-10">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-2">
                                                            <select class="form-control input-sm" multiple id="name_lvs" style="width: 100%">
                                                        ...
                                                        <div class="col-md-2">
                                                            <input class="input-sm form-control" id="ma_lvs" placeholder="Mã lưu vực sông" />
                                                        </div>
                                                        <!-- Tìm kiếm -->
                                                        <div class="col-md-4">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_luuvucsong">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-luuvucsong" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-luuvucsong">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="lvs_table" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_lvs">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_lvs">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <a href="#" class="btn btn-success btn-sm" id="export_lvs">
                                                        <i class="ti-export pdd-right-5"></i>
    ...
    <script src="js/luuvucsong.js"></script>
