                                            ...
                                            <div class="col-md-12">
                                                <form class="form-horizontal mrg-top-10 pdd-right-10">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input class="input-sm form-control" id="name_standard" placeholder="Quy chuẩn" />
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Thông số</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <input class="input-sm form-control" id="name_para" placeholder="Thông số" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input class="input-sm form-control" id="name_analysis_method" placeholder="Phương pháp phân tích" />
                                                        </div>
                                                        <!-- Tìm kiếm -->
                                                        <div class="col-md-4">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_ct">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-ct" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-ct">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="ct_table" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_ct">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_ct">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <a href="#" class="btn btn-success btn-sm" id="export_ct">
                                                        <i class="ti-export pdd-right-5"></i>
