...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b> DANH SÁCH ĐỐI TƯỢNG KHAI THÁC SỬ DỤNG </b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                              ...
                              <b>Tên đối tượng khai thác sử dụng</b>
                            </label>
                                                        <div class="col-md-4">
                                                            <input class="input-sm form-control" id="name_dt_ktsd" placeholder="Tên đối tượng khai thác sử dụng" />
                                                        </div>
                                                        <!-- Tìm kiếm -->
                                                        <div class="col-md-4">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_dt_ktsd">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-dt-ktsd" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-dt-ktsd">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="dt_ktsd_table" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_dt_ktsd">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_dt_ktsd">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <a href="#" class="btn btn-success btn-sm" id="export_dt_ktsd">
                                                        <i class="ti-export pdd-right-5"></i>
    ...
    <script src="js/doituongktsd.js"></script>
