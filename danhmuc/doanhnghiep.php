...
<body>
   ...
   <span>Đăng xuất</span>
                                            ...
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-10">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control" id="name_enterprise" multiple style="width: 100%">
                                                                <!-- DOM option from DB -->
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="input-sm form-control" id="nguoidaidien" placeholder="Người đại diện"></input>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-10">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="input-sm form-control" id="address_enterprise" placeholder="Địa chỉ doanh nghiệp"></input>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="text" class="input-sm form-control" id="tin_enterprise" placeholder="Mã số thuế"></input>
                                                        </div>
                                                        <!-- Tìm kiếm -->
                                                        <div class="col-md-4">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_enterprise">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-enterprise" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-enterprise">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="enterprise_table" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_enterprise">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_enterprise">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <a href="#" class="btn btn-success btn-sm" id="export_enterprise">
                                                        <i class="ti-export pdd-right-5"></i>
    ...
    <script src="js/doanhnghiep.js"></script>
