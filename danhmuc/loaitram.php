...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              ...
                              <b>Tên loại trạm</b>
                                                        ...
                                                        <div class="col-md-4">
                                                            <input class="input-sm form-control" id="name_loaitram" placeholder="Tên loại trạm" />
                                                        </div>
                                                        <!-- Tìm kiếm -->
                                                        <div class="col-md-4">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_loaitram">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-loaitram" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-loaitram">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="loaitram_table" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_loaitram">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_loaitram">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <a href="#" class="btn btn-success btn-sm" id="export_loaitram">
                                                        <i class="ti-export pdd-right-5"></i>
    ...
    <script src="js/loaitram.js"></script>
