...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                                ...
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row mrg-left-10" style="margin-top: -5px">
                                                        ...
                                                        <div class="col-md-5 pdd-left-40">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_ctkt_nn">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-ctkt-nn" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-ctkt-nn">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="ctkt_nn_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="js/ctkt-nguonnuoc.js"></script>
