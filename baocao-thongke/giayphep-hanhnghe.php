                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>
                                                THỐNG KÊ GIẤY PHÉP HÀNH NGHỀ KHOAN NƯỚC DƯỚI ĐẤT
                                            </b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control">
                                                                <option value="none" selected>Toàn bộ</option>
                                                                <option value="none">Hết hiệu lực</option>
                                                                <option value="none">Còn hiệu lực</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <input type="text" id="date-range-picker" class="form-control" value="01/01/2015 - 01/31/2015" placeholder="Date range picker" style="height: 1.85rem" />
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row" style="margin-top: -5px">
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="form-5" id="rangeTime-option" checked>
                                                            <label for="rangeTime-option">
                                                                Khoảng thời hạn cấp phép
                                                            </label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="form-5" id="ngaycap-option">
                                                            <label for="ngaycap-option">
                                                                Ngày cấp phép
                                                            </label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="form-5" id="ngayhet-option">
