...
<body>
                ...
                <div class="side-nav-inner">
                    ...
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown open">
                            ...
                            <ul class="dropdown-menu">
                                <!--<li>
                                    <a href="giayphep-nuocmat.php" class="">Giấy phép Nước mặt</a>
                                </li>
                                <li>
                                    <a href="giayphep-nuocduoidat.php" class="">Giấy phép Nước dưới đất</a>
                                </li>-->
                                <li>
                                    <a href="giayphep-xathai.php" class="">Giấy phép Xả thải</a>
                                </li>
                                <!--<li>
                                    <a href="giayphep-thamdo.php" class="">Giấy phép Thăm dò</a>
                                </li>-->
                                <!-- <li>
                                    <a href="giayphep-hanhnghe.php" class="">Giấy phép Hành nghề</a>
                                </li> -->
                                <li>
                                    <a href="thongke-tramquantrac.php" class="">Thống kê Trạm quan trắc</a>
                                </li>
                                <li>
                                    <a href="hochua-lvs.php" class="">Tổng hợp hồ chứa, LVS</a>
                                </li>
                                <li>
                                    <a href="ctkt-nguonnuoc.php" class="">Số CTKT theo Nguồn nước</a>
                                </li>
                                <li>
                                    <a href="ctkt-mucdichsudung.php" class="">Số CTKT theo MĐSD</a>
                                </li>
                                <!-- <li>
                                    <a href="ctkt-loaihinh.php" class="">Số CTKT theo Loại hình</a>
                                </li>
                                <li>
                                    <a href="water-ktsd-cp.php" class="">Lượng nước KTSD được CP</a>
                                </li> -->
                                <li>
                                    <a href="gp-dacap.php" class="">Số lượng GP đã cấp</a>
                                </li>
                                <li>
                                    <a href="tien-cqkt.php" class="">Tiền cấp quyền KT</a>
                                </li>
                                <!--<li>
                                    <a href="danhmuc-ctktsd.php" class="">Danh mục CTKTSD</a>
                                </li>-->
                            </ul>
                        </li>
   ...
   <span>Đăng xuất</span>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>
                                                THỐNG KÊ GIẤY PHÉP XẢ NƯỚC THẢI VÀO NGUỒN NƯỚC
                                            </b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control" id="status_gpxt">
                                                    ...
                                                    <div class="form-group row">
                                                        <input type="text" id="rangeDate_gpxt" class="form-control" placeholder="Date range picker" style="height: 1.85rem" />
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select id="tiepnhan_option" multiple="multiple" style="width: 100%">
                                                                <!-- DOM từ DB -->
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row" style="margin-top: -5px">
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="loaingay-option" id="ngaycap-option" value="ngaycap" checked>
                                                            <label for="ngaycap-option">
                                                                Ngày cấp phép
                                                            </label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="loaingay-option" id="ngayhet-option" value="ngayhet">
                                                            <label for="ngayhet-option">
                                                                Ngày hết hạn
                                                            </label>
                                                        </div>
                                                        <!-- Tìm kiếm -->
                                                        <div class="col-md-5 pdd-left-50">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_gpxt">
                                                                <i class="ti-search pdd-right-5"></i>
                                                                <span>Tìm kiếm</span>
                                                            </a>
                                                            <a href="#" class="btn btn-success btn-sm" id="export_gpxt">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-gpxt" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-gpxt">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="gpxt_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="../vendors/tabulator/dist/js/tabulator.js"></script>v
    ...
    <script src="js/giayphep-xathai.js"></script>
