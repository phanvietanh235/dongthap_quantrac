...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-hochua-lvs" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-hochua-lvs">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="hochua_lvs_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="js/hochua-lvs.js"></script>
