...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row mrg-left-10" style="margin-top: -5px">
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="filter-option" id="quanhuyen-option" value="district" checked>
                                                            <label for="quanhuyen-option">
                                                                Quận huyện/Phường xã
                                                            </label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="filter-option" id="tangchuanuoc-option" value="waterfloor">
                                                            <label for="tangchuanuoc-option">
                                                                Tầng chứa nước
                                                            </label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="filter-option" id="basin-option" value="basin">
                                                            <label for="basin-option">
                                                                Lưu vực sông
                                                            </label>
                                                        </div>
                                                        <!-- Tìm kiếm -->
                                                        <div class="col-md-5 pdd-left-40">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_ctkt_mdsd">
                                            ...
                                            <div class="col-md-12">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select id="tangchuanuoc" multiple="multiple" style="width: 100%" disabled>
                                                                <!-- DOM từ DB -->
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select id="luuvucsong" multiple="multiple" style="width: 100%" disabled>
                                                                <!-- DOM từ DB -->
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-ctkt-mdsd" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-ctkt-mdsd">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="ctkt_mdsd_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="js/ctkt-mucdichsudung.js"></script>
