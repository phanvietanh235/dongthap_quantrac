...
<body>
   ...
   <span>Đăng xuất</span>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>
                                                THỐNG KÊ GIẤY PHÉP THĂM DÒ NƯỚC DƯỚI ĐẤT
                                            </b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="form-control" id="status_gptd">
                                                    ...
                                                    <div class="form-group row">
                                                        <input type="text" id="rangeDate_gptd" class="form-control" placeholder="Date range picker" style="height: 1.85rem" />
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row" style="margin-top: -5px">
                                                        ...
                                                        <div class="col-md-5 pdd-left-40">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_gptd">
                                                                <i class="ti-search pdd-right-5"></i>
                                                                <span>Tìm kiếm</span>
                                                            </a>
                                                            <a href="#" class="btn btn-success btn-sm" id="export_gptd">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-gptd" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-gptd">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="gptd_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="js/giayphep-thamdo.js"></script>
