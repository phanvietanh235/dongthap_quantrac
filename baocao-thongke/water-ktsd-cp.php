                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>
                                                LƯỢNG NƯỚC KHAI THÁC, SỬ DỤNG (QUY MÔ)
                                                ĐÃ ĐƯỢC CẤP GIẤY PHÉP KHAI THÁC TÀI NGUYÊN NƯỚC
                                            </b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row mrg-left-10" style="margin-top: -5px">
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="form-5" id="quanhuyen-option" checked>
                                                            <label for="quanhuyen-option">
                                                                Quận huyện
                                                            </label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="form-5" id="tangchuanuoc-option">
                                                            <label for="tangchuanuoc-option">
                                                                Tầng chứa nước
                                                            </label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="form-5" id="luuvucsong-option">
                                                            <label for="luuvucsong-option">
                                                                Lưu vực sông
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-3">
                                                            <select class="form-control">
                                                                <option value="none" selected>--Lựa chọn Quận/Huyện--
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <select class="form-control">
                                                                <option value="none" selected>--Lựa chọn Tầng chứa nước--
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <select class="form-control">
                                                                <option value="none" selected>--Lựa chọn Lưu vực sông--
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
