...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                            ...
                                            <div class="col-md-12">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_tien_cqkt">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-tiencqkt" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-tiencqkt">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="tien_cqkt_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="js/tien-cqkt.js"></script>
