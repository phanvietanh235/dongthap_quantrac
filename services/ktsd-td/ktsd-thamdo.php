...
/*---- Thông tin Danh sách công trình KTSD td ----*/
$querry_data = 'SELECT * FROM list_ktsd_td ';
$querry_data .= 'WHERE ';
...
$querry_data .= '("soGiayPhepTD" IS NULL OR "soGiayPhepTD" ILIKE ' . "'%" . $sogiayphep . "%'" . ') AND ';
