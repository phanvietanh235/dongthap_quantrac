...
if (isset($_GET["idgp"])) {
    $querry_gp_td = 'SELECT thongtincp_td.*, loaigiayphep.name "LoaiGiayPhep", ctktsd."coSoKTSD", 
                        ...
                        WHERE thongtincp_td.ma_congtrinhktsd =' . "'" . $macongtrinh . "'" . "AND thongtincp_td.id =" . "'" . $_GET["idgp"] . "'";
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold">
                                            THÔNG TIN GIẤY PHÉP THĂM DÒ NƯỚC DƯỚI ĐẤT
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="upload-gp-td.php" class="form-horizontal" id="fileinfo" name="fileinfo" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idgp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="sogiayphep" 
                                                                    value=' . '"' . $data_gp_td[0]["soGiayPhepTD"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="sogiayphep"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idgp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="thoihan_cp" 
                                                                        value=' . '"' . $data_gp_td[0]["thoiHanGiayPhep"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="thoihan_cp"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idgp'])) {
                                                                if (is_null($data_gp_td[0]["ngayCapPhep"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="ngaycapphep" 
                                                                            value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    $ngaycapphep = explode("-", $data_gp_td[0]["ngayCapPhep"]);
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idgp'])) {
                                                                if (is_null($data_gp_td[0]["ngayHetHan"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="ngayhethan" 
                                                                            value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    $ngayhethan = explode("-", $data_gp_td[0]["ngayHetHan"]);
                                                        ...
                                                        <div class="col-md-2">
                                                            <select class="form-control input-sm" id="tinhtrang_gp">
                                                                <?php
                                                                if ($data_gp_td[0]["tinhTrangGiayPhep"] == 't') {
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="mucdich_td" 
                                                                        value=' . '"' . $data_gp_td[0]["thoiHanGiayPhep"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="mucdich_td"/>';
                                                            }
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="quymo_td" 
                                                                        value=' . '"' . $data_gp_td[0]["thoiHanGiayPhep"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="quymo_td"/>';
                                                            }
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input type="file" name="uploaded_qp_td" style="margin-top: 3px; width: 165px">
                                                            <input type="submit" value="" id="hidden-submit-gp" hidden/>
                                                            <?php
                                                            /*---- Khi có idgq thì cần tạo 1 input ẩn để lưu input nhằm upload file----*/
                                                            if (isset($_GET['idgp'])) {
                                                                if (isset(explode("/", $data_gp_td[0]['taiLieuDinhKem'])[9])) {
                                                                    $filename = explode("/", $data_gp_td[0]['taiLieuDinhKem'])[9];
                                                                } else {
                                                                    $filename = explode("/", $data_gp_td[0]['taiLieuDinhKem'])[8];
                                                                }

                                                                echo '<input type="hidden" id="id_gp" name="id_gp" value="' . $_GET['idgp'] . '">
                                                                        <span class="text-info" id="gp_td_file">' . $filename . '</span>';
                                                            }
                                                            ?>
                                                        </div>
                                                        <div class="col-md-6" style="margin-left: -55px">
                                                            <?php
                                                            if (isset($_GET['idgp'])) {
                                                                echo '<a id="modal-gp-td" class="btn-xs btn btn-info btn-sm" style="cursor: pointer"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_gp_td">
    ...
    <script>
        $("#modal-gp-td").click(function() {
            <?php
            if (isset($_GET['idgp'])) {
                echo "PDFObject.embed(" . "'" . $data_gp_td[0]['taiLieuDinhKem'] . "'," .
    ...
    <script>
        ...
        $.getJSON("../loaigiayphep.php", function(loaigiayphep) {
            ...
            $.each(loaigiayphep, function(key, value) {
                ...
                <?php
                if (isset($_GET['idgp'])) {
                    echo 'if (value.id == ' . $data_gp_td[0]["ma_loaigiayphep"] . ') {
                            $("#loaigiayphep")
                                .append($("<option></option>")
        ...
        if (isset($_GET['idgp'])) {
            $querry_option = 'SELECT * FROM "Enterprise"'
                . ' WHERE id=' . $data_gp_td[0]["ma_doanhnghiep"];
        ...
        $.getJSON("../donvicapphep.php", function(donvi_cp) {
            ...
            $.each(donvi_cp, function(key, value) {
                ...
                <?php
                if (isset($_GET['idgp'])) {
                    echo 'if (value.id == ' . $data_gp_td[0]["ma_donvicapphep"] . ') {
                            $("#donvi_cp")
                                .append($("<option></option>")
                                    .attr("value", value.id).attr("selected", "selected").text(value.name));
                            } else {
        ...
        $.getJSON("../donviquanly.php", function(donvi_ql) {
            ...
            $.each(donvi_ql, function(key, value) {
                ...
                <?php
                if (isset($_GET['idgp'])) {
                    echo 'if (value.id == ' . $data_gp_td[0]["ma_donviquanly"] . ') {
                            $("#donvi_ql")
                                .append($("<option></option>")
                                    .attr("value", value.id).attr("selected", "selected").text(value.name));
                            } else {
    ...
    <script>
        ...
        <?php
        if (isset($_GET['idgp'])) {
            echo '$("input[name=' . "'" . "uploaded_qp_td" . "'" . ']").change(function(){
                    $("#gp_td_file").hide();
                    $("#modal-gp-td").hide();
                    });';
        }
        ...
        $("#save_gp_td").click(function() {
            ...
            var fileName = $("input[name='uploaded_qp_td']").val().split('/').pop().split('\\').pop();
            var tailieudinhkem = tailieudinhkem_host + "services/ktsd-td/upload-files/" +
                <?php
                if (isset($_GET['idgp'])) {
            ...
            var response_post = $.post("save-gp-td.php", {
                <?php
                if (isset($_GET['idgp'])) {
