...
if (isset($_GET["idgieng"])) {
    $querry_poi_td_ndd = 'SELECT diemtd_ndd.*, tangchuanuoc.name "TangChuaNuoc" FROM "DiemTD_NDD" diemtd_ndd
                                    ...
                                    WHERE ma_congtrinhktsd =' . "'" . $macongtrinh . "'" . "AND diemtd_ndd.id =" . "'" . $_GET["idgieng"] . "'";
    $result_poi_td_ndd = pg_query($tiengiang_db, $querry_poi_td_ndd);
    if (!$result_poi_td_ndd) {
        echo "Không có dữ liệu.\n";
        exit;
    }
    $data_poi_td_ndd = array();
    while ($row = pg_fetch_assoc($result_poi_td_ndd)) {
        $data_poi_td_ndd[] = $row;
    }
}
?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="sohieugieng" 
                                                                    value=' . '"' . $data_poi_td_ndd[0]["soHieuGiengTD"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="sohieugieng"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX" 
                                                                    value=' . '"' . $data_poi_td_ndd[0]["toaDoX"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY" 
                                                                    value=' . '"' . $data_poi_td_ndd[0]["toaDoY"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Chiều sâu dự kiến thăm dò</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="chieusau_dukien" 
                                                                    value=' . '"' . $data_poi_td_ndd[0]["chieuSauDuKienTD"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="chieusau_dukien"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Số lượng giếng thăm dò</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="soluong_giengtd" 
                                                                    value=' . '"' . $data_poi_td_ndd[0]["soLuongGiengTD"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="soluong_giengtd"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="vung_baoho" 
                                                                    value=' . '"' . $data_poi_td_ndd[0]["vungBHVS"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="vung_baoho"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<textarea class="form-control" id="mota_vungbaoho">' .
                                                                    $data_poi_td_ndd[0]["moTaVungBHVS"] . '</textarea>';
                                                            } else {
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tình trạng thăm dò</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <select class="form-control input-sm" id="tinhtrang_thamdo">
                                                                <?php
                                                                if ($data_poi_td_ndd[0]["tinhtrangthamdo"] == 't') {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_poi_td_ndd">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <?php
                                                    echo '<a href=' . '"ktsd-td-info.php?macongtrinh=' . $macongtrinh . '"'
    ...
    <script>
        ...
        $.getJSON("../tangchuanuoc-option.php", function(tang_chuanuoc) {
            ...
            $.each(tang_chuanuoc, function(key, value) {
                ...
                <?php
                if (isset($_GET['idgieng'])) {
                    echo 'if (value.id == ' . $data_poi_td_ndd[0]["ma_tangchuanuoc"] . ') {
                            $("#tang_chuanuoc")
                                .append($("<option></option>")
        ...
        $("#save_poi_td_ndd").click(function() {
            ...
            if (toadoX == "" || toadoY == "") {
                ...
                var response_post = $.post("save-poi-ktsd-td.php", {
                    ...
                    "toadoX": toadoX,
                    "toadoY": toadoY,
                    "chieusau_dukien": chieusau_dukien,
                    "soluong_giengtd": soluong_giengtd,
                    "vung_baoho": vung_baoho,
                    "mota_vungbaoho": mota_vungbaoho,
                    "tinhtrang_thamdo": tinhtrang_thamdo
                }).done(function(data) {
                    if (data == "error") {
