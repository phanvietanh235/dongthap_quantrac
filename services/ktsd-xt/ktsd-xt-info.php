...
$querry_info_ctkt = 'SELECT ctktsd.*, doituong_ktsd."tenDoiTuongKTSD",
                        ...
                        thongtincpxt."tongLLXaLonNhat", thongtincpxt."tongLLXaLonNhatMuaKho",
                        thongtincpxt."tongSoDiemXa", thongtincpxt."tinhTrangGiayPhep" FROM "CT_KTSD" ctktsd
                        ...
                        LEFT JOIN "ThongTinCP_XT" thongtincpxt ON ctktsd.id = thongtincpxt.ma_congtrinhktsd
...
/*---- Thông tin điểm XT ----*/
$querry_poi_ktsd_xt = 'SELECT "DiemXT".*, luuvucsong.name "LuuVucSong" FROM "DiemXT" 
...
$jsonData_poi_ktsd_xt = json_encode($data_poi_ktsd_xt);
$original_poi_ktsd_xt = json_decode($jsonData_poi_ktsd_xt, true);
$option_poi_ktsd_xt = array();
foreach ($original_poi_ktsd_xt as $key => $value_poi_ktsd_xt) {
    $option_poi_ktsd_xt[] = array(
        'STT' => $key + 1,
        "id_diem" => $value_poi_ktsd_xt['id'],
        "sohieudiem" => $value_poi_ktsd_xt['soHieuDiem'],
        "luuvucsong" => $value_poi_ktsd_xt['LuuVucSong'],
        "toadoX" => (float)$value_poi_ktsd_xt['toaDoX'],
        "toadoY" => (float)$value_poi_ktsd_xt['toaDoY'],
        "luuLuongXT" => $value_poi_ktsd_xt['luuLuongXT'],
        "cheDoXT" => $value_poi_ktsd_xt['cheDoXT'],
        "nguonTiepNhanNT" => $value_poi_ktsd_xt['nguonTiepNhanNT'],
        "mucDichXT" => $value_poi_ktsd_xt['mucDichXT'],
        "phuongThucXT" => $value_poi_ktsd_xt['phuongThucXT'],
        "chatLuongNT" => $value_poi_ktsd_xt['chatLuongNT'],
        "tinhtrangxathai" => $value_poi_ktsd_xt['tinhtrangxathai'] == 'f' ? 'Còn hoạt động' : 'Đang hoạt động',
        "loaiNT" => $value_poi_ktsd_xt["loaiNT"],
        "tanSuatQuanTrac" => $value_poi_ktsd_xt["tanSuatQuanTrac"]
    );
}
$final_poi_ktsd_xt = json_encode($option_poi_ktsd_xt);
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                            ...
                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            echo '<input class="form-control input-sm" id="tongdiemxa"
                                                                type="text"' . 'value=' . '"' . $data_info_ctkt[$i_check]["tongSoDiemXa"] . '"' . '>'
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tổng lưu lượng xả lớn nhất</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            echo '<input class="form-control input-sm" id="tong-llxt"
                                                                type="text"' . 'value=' . '"' . $data_info_ctkt[$i_check]["tongLLXaLonNhat"] . '"' . '>'
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tổng lưu lượng mùa khô</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            echo '<input class="form-control input-sm" id="tong-llxt-muakho"
                                                                type="text"' . 'value=' . '"' . $data_info_ctkt[$i_check]["tongLLXaLonNhatMuaKho"] . '"' . '>'
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="poi_ktsd_xt" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_poi_ktsd_xt">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_poi_ktsd_xt">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <!-- <a href="#" class="btn btn-success btn-sm" id="export_poi_ktsd_xt">
                                                        <i class="ti-export pdd-right-5"></i>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="gp_xt" class="table table-sm table-hover table-bordered">
                                                    <!-- DOM after Process Data -->
                                                </table>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_gp_xt">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_gp_xt">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <!-- <a href="#" class="btn btn-success btn-sm" id="export_gp_xt">
                                                        <i class="ti-export pdd-right-5"></i>
                                                        <span>Xuất dữ liệu</span>
                                                    </a> -->
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold text-info">
                                            Tình hình vi phạm công trình Xả thải của Chủ công trình
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="thvp_xt" class="table table-sm table-hover table-bordered">
                                                    <!-- DOM after Process Data -->
                                                </table>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_thvp_xt">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_thvp_xt">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <!-- <a href="#" class="btn btn-success btn-sm" id="export_thvp_xt">
                                                        <i class="ti-export pdd-right-5"></i>
                                                        <span>Xuất dữ liệu</span>
                                                    </a> -->
                                                </div>
    ...
    <script>
        ...
        var columns_title = [{
            ...
            },
            {
                ...
                cellClick: function(e, row, formatterParams) {
                    ...
                    window.open("../../map.php?idpoi=" + iddiem + "&type=xt")
                }
            },
            {
                title: "#",
            ...
            },
            {
                ...
                formatterParams: {
                    ...
                    <?php
                    echo 'urlPrefix: "form-poi-ktsd-xt.php?macongtrinh=' . $macongtrinh . '&iddiem=",'
                    ?>
                    target: "_blank",
                }
            },
            ...
            {
                title: "Lượng nước xả thải",
                field: "luuLuongXT",
                hozAlign: "center"
            },
            {
                title: "Chế độ xả thải",
                field: "cheDoXT",
                hozAlign: "center"
            },
            {
                title: "Nguồn tiếp nhận nước thải",
                field: "nguonTiepNhanNT",
                hozAlign: "center"
            },
            {
                title: "Mục đích xả thải",
                field: "mucDichXT",
                hozAlign: "center"
            },
            {
                title: "Phương thức xả thải",
                field: "phuongThucXT",
                formatter: "textarea",
                width: 350
            },
            ...
            {
                title: "Tình trạng xả thải",
                field: "tinhtrangxathai",
                hozAlign: "center"
            },
            {
                title: "Loại nước thải",
                field: "loaiNT",
                hozAlign: "center"
            },
            {
                title: "Tần suất quan trắc",
                field: "tanSuatQuanTrac",
                formatter: "textarea",
                width: 350
            }
        ];
        /*---- Lấy JSON bằng Php ----*/
        <?php
        $script = 'var tabledata = ' . $final_poi_ktsd_xt . ";";
        echo $script;
        ?>

        $("#poi_ktsd_xt").css("border-top", "1px solid #dee2e6");
        var selected_id;
        var table = new Tabulator("#poi_ktsd_xt", {
        ...
        /*** Delete DiemKTSD_xt ***/
        $("#delete_poi_ktsd_xt").click(function(e) {
            e.preventDefault();
            if (selected_id.length == 0) {
                alert("Vui lòng chọn điểm xả thải cần xóa")
            } else {
                if (confirm("Bạn chắc chắn muốn xóa các điểm xả thải đã chọn này ?")) {
                    var id_diem = [];
                    selected_id.forEach(function(item, index) {
                        /*** Get id_diem ***/
                        id_diem.push(item.id_diem);
                    })
                    var response_post = $.post("delete-poi-ktsd-xt.php", {
                        <?php
        ...
        $("#create_poi_ktsd_xt").click(function(e) {
            e.preventDefault();
            <?php
            echo 'location.href = "form-poi-ktsd-xt.php?macongtrinh=' . $macongtrinh . '"';
            ?>
        })
    </script>
