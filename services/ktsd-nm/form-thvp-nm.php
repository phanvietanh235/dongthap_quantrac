...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold">
                                            TÌNH HÌNH VI PHẠM KHAI THÁC SỬ DỤNG NƯỚC MẶT
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdxp" 
                                                                    value=' . '"' . $data_thvp_nm[0]["quyetDinhXP"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdxp"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idthvp'])) {
                                                                if (is_null($data_thvp_nm[0]["ngayXP"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="ngayxuphat" 
                                                                        value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    $ngayXP = explode("-", $data_thvp_nm[0]["ngayXP"]);
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="hinhthuc_xp" 
                                                                    value=' . '"' . $data_thvp_nm[0]["hinhThucXP"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="hinhthuc_xp"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<textarea class="form-control" id="noidung_xuphat">' .
                                                                    $data_thvp_nm[0]["noiDungXP"] . '</textarea>';
                                                            } else {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_thvp_nm">
    ...
    <script>
        ...
        $.getJSON("../doanhnghiep.php", function(doanhnghiep) {
            ...
            $.each(doanhnghiep, function(key, value) {
                ...
                <?php
                if (isset($_GET['idthvp'])) {
                    echo 'if (value.id == ' . $data_thvp_nm[0]["ma_doanhnghiep"] . ') {
                            $("#doanhnghiep")
                                .append($("<option></option>")
    ...
    <script>
        ...
        $("#save_thvp_nm").click(function() {
            ...
            var response_post = $.post("save-thvp-nm.php", {
                <?php
                if (isset($_GET['idthvp'])) {
                    /*** Update TinhHinhXuPhat_nm ***/
                    echo 'id_thvp:' . $_GET['idthvp'] . ', ' .
                        'macongtrinh:' . $macongtrinh . ', ';
                } else {
                    /*** Insert TinhHinhXuPhat_nm ***/
