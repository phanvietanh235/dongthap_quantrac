...
if (isset($_GET["idtiencq"])) {
    $querry_tiencq_nm = 'SELECT tiencq_nm.*, thongtincp_nm."soGiayPhepNM" FROM "TienCapQuyen_NM" tiencq_nm
                                    LEFT JOIN "ThongTinCP_NM" thongtincp_nm on tiencq_nm.ma_giayphepnm = thongtincp_nm.id
                                    WHERE tiencq_nm.id =' . "'" . $_GET["idtiencq"] . "'";
    ...
    $tiennop_hangnam = explode(";", $data_tiencq_nm[0]["soTienNopHangNam"]);
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold">
                                            THÔNG TIN TIỀN CẤP QUYỀN KHAI THÁC SỬ DỤNG NƯỚC MẶT
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdpd" 
                                                                    value=' . '"' . $data_tiencq_nm[0]["quyetDinhPheDuyetTCQ"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdpd"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idtiencq'])) {
                                                                if (is_null($data_tiencq_nm[0]["ngayBanHanhQDPD"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="ngay_banhanh" 
                                                                        value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    $ngaybanhanh = explode("-", $data_tiencq_nm[0]["ngayBanHanhQDPD"]);
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="tongtiennop" 
                                                                    value=' . '"' . $data_tiencq_nm[0]["tongTienNop"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="tongtiennop"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="pa_nop" 
                                                                    value=' . '"' . $data_tiencq_nm[0]["phuongAnNop"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="pa_nop"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="thoigian_nop" 
                                                                    value=' . '"' . $data_tiencq_nm[0]["thoiGianNop"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="thoigian_nop"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="thongbao" 
                                                                        value=' . '"' . $data_tiencq_nm[0]["thongBaoPheDuyet"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="thongbao"/>';
                                                            }
                                                            ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_tiencq_nm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <?php
                                                    echo '<a href=' . '"ktsd-nm-info.php?macongtrinh=' . $macongtrinh . '"'
    ...
    <script>
        ...
        <?php
        $script = '$.getJSON("../thongtingp-nm-option.php?macongtrinh=' . $macongtrinh . '", function (gpnm_option) {';
        /* $script.= '$("#sogiayphep")
                .append($("<option></option>")
                    .attr("value", "none").text("--Chọn giấy phép--")); */
        $script .= '$.each(gpnm_option, function (key, value) {';

        if (isset($_GET['idtiencq'])) {
            $script .= 'if (value.id == ' . $data_tiencq_nm[0]["ma_giayphepnm"] . ') {
                    $("#sogiayphep")
                        .append($("<option></option>")
                            .attr("value", value.id).attr("selected", "selected").text(value.sogp_nm));
                    } else {
                        $("#sogiayphep")
                            .append($("<option></option>")
                                .attr("value", value.id).text(value.sogp_nm));
                    }';
        } else {
            $script .= '$("#sogiayphep")
                    .append($("<option></option>")
    ...
    <script>
        ...
        $("#save_tiencq_nm").click(function() {
            ...
            var response_post = $.post("save-tiencq-nm.php", {
                <?php
                if (isset($_GET['idtiencq'])) {
