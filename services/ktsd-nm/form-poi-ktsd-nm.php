...
if (isset($_GET["iddiem"])) {
    $querry_poi_ktsd_nm = 'SELECT diemktsd_nm.*, luuvucsong.name "LuuVucSong" FROM "DiemKTSD_NM" diemktsd_nm
                                ...
                                WHERE ma_congtrinhktsd =' . "'" . $macongtrinh . "'" . "AND diemktsd_nm.id =" . "'" . $_GET["iddiem"] . "'";
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="sohieudiem" 
                                                                    value=' . '"' . $data_poi_ktsd_nm[0]["soHieuDiem"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="sohieudiem"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX" 
                                                                    value=' . '"' . $data_poi_ktsd_nm[0]["toaDoX"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY" 
                                                                    value=' . '"' . $data_poi_ktsd_nm[0]["toaDoY"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Lưu lượng mùa khô</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="llkt_muakho" 
                                                                    value=' . '"' . $data_poi_ktsd_nm[0]["luuLuongKTLNMuaKho"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="llkt_muakho"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Lưu lượng lớn nhất</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="llkt" 
                                                                    value=' . '"' . $data_poi_ktsd_nm[0]["luuLuongKTLN"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="llkt"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="chedo_kt" 
                                                                    value=' . '"' . $data_poi_ktsd_nm[0]["cheDoKT"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="chedo_kt"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="nguon_kt" 
                                                                    value=' . '"' . $data_poi_ktsd_nm[0]["nguonKhaiThac"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="nguon_kt"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="vung_baoho" 
                                                                        value=' . '"' . $data_poi_ktsd_nm[0]["vungBHVS"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="vung_baoho"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tình trạng khai thác</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <select class="form-control input-sm" id="tinhtrang_khaithac">
                                                                <?php
                                                                if ($data_poi_ktsd_nm[0]["tinhtrangkhaithac"] == 't') {
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<textarea class="form-control" id="mota_vungbaoho">' .
                                                                    $data_poi_ktsd_nm[0]["moTaVungBHVS"] . '</textarea>';
                                                            } else {
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<textarea class="form-control" id="phuongthuc_kt">' .
                                                                    $data_poi_ktsd_nm[0]["phuongThucKT"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="phuongthuc_kt"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_poi_ktsd_nm">
    ...
    <script>
        ...
        $.getJSON("../basin-option.php", function(luuvucsong) {
            ...
            $.each(luuvucsong, function(key, value) {
                ...
                <?php
                if (isset($_GET['iddiem'])) {
                    echo 'if (value.id == ' . $data_poi_ktsd_nm[0]["ma_luuvucsong"] . ') {
                            $("#luuvucsong")
                                .append($("<option></option>")
        ...
        $("#save_poi_ktsd_nm").click(function() {
            ...
            if (toadoX == "" || toadoY == "") {
                ...
                var response_post = $.post("save-poi-ktsd-nm.php", {
                    ...
                    "tinhtrang_khaithac": tinhtrang_khaithac
                }).done(function(data) {
                    if (data == "error") {
