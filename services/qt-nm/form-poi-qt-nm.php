...
if (isset($_GET["iddiem"])) {
    $querry_poi_qt_nm = 'SELECT diemqt_nm.*, luuvucsong.name "LuuVucSong" FROM "DiemQT_NM" diemqt_nm
                                        ...
                                        WHERE ma_congtrinhktsd =' . "'" . $macongtrinh . "'" . "AND diemqt_nm.id =" . "'" . $_GET["iddiem"] . "'";
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="soHieuDiemQT" 
                                                                    value=' . '"' . $data_poi_qt_nm[0]["soHieuDiemQT"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="soHieuDiemQT"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="tuanSuatBaoTri" 
                                                                    value=' . '"' . $data_poi_qt_nm[0]["tuanSuatBaoTri"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="tuanSuatBaoTri"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['iddiem'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="ma_tramcu" 
                                                                    value=' . '"' . $data_poi_qt_nm[0]["ma_tramcu"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="ma_tramcu"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <select class="form-control input-sm" id="tinhTrangHoatDong">
                                                                <?php
                                                                if ($data_poi_qt_nm[0]["tinhTrangHoatDong"] == 't') {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_poi_qt_nm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <?php
                                                    echo '<a href=' . '"qt-nm-info.php?macongtrinh=' . $macongtrinh . '"'
    ...
    <script>
        ...
        $.getJSON("../basin-option.php", function(luuvucsong) {
            ...
            $.each(luuvucsong, function(key, value) {
                ...
                <?php
                if (isset($_GET['iddiem'])) {
                    echo 'if (value.id == ' . $data_poi_qt_nm[0]["ma_luuvucsong"] . ') {
                            $("#luuvucsong")
                                .append($("<option></option>")
    ...
    <script>
        $("#save_poi_qt_nm").click(function() {
            ...
            if (toadoX == "" || toadoY == "") {
                ...
                var response_post = $.post("save-poi-qt-nm.php", {
                    <?php
                    if (isset($_GET['iddiem'])) {
                        /*** Update Thông tin Diemqt_nm ***/
                        echo 'id_diem:' . $_GET['iddiem'] . ', ' .
                            'macongtrinh:' . $macongtrinh . ', ';
                    } else {
                        /*** Insert Thông tin Diemqt_nm ***/
