...
if (isset($_GET["idsoHieu"])) {
    ...
    $querry_poi_diemqt_nm = 'SELECT diemqt_nm.*, diadanh.name "DiaDanh",luuvucsong.name "Basin" FROM "DiemQT_NM" diemqt_nm
                                ...
                                LEFT JOIN "Location" diadanh ON diemqt_nm.ma_diadanhqt = diadanh.id
                                WHERE diemqt_nm.id ='."'".$idsoHieu."'";
    $result_poi_diemqt_nm = pg_query($tiengiang_db, $querry_poi_diemqt_nm);
    if (!$result_poi_diemqt_nm) {
        echo "Không có dữ liệu.\n";
        exit;
    }
    $data_poi_diemqt_nm = array();
    while ($row = pg_fetch_assoc($result_poi_diemqt_nm)) {
        $data_poi_diemqt_nm[] = $row;
    }
}
?>
<?php
...
<body>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold">
                                            THÔNG TIN ĐIỂM QUAN TRẮC NƯỚC MẶT
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Số hiệu điểm quan trắc</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="soHieuDiemQT" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["soHieuDiemQT"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="soHieuDiemQT"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="ma_tramcu" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["ma_tramcu"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="ma_tramcu"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["coordX"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["coordY"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tần suất bảo trì</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="tuanSuatBaoTri" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["tuanSuatBaoTri"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="tuanSuatBaoTri"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control input-sm" id="tinhTrangHoatDong">
                                                                <?php
                                                                if ($data_poi_diemqt_nm[0]["tinhTrangHoatDong"] == 't') {
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="congtrinh" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["ma_congtrinhktsd"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="congtrinh1"/>';
                                                            }
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="diadanh" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["ma_diadanhqt"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="diadanh"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Mã điểm quan trắc</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idsoHieu'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="madiemqt" 
                                                                            value=' . '"' . $data_poi_diemqt_nm[0]["ma_diemqt_nm"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="madiemqt"/>';
                                                            }
                                                            ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_poi_diemqt_nm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <a href='../../congtrinh-quantrac/diemqt-nm.php' class="btn btn-info btn-sm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Quay lại</span>
                                                    </a>
                                                </div>
    ...
    <script>
        ...
        if (isset($_GET['idsoHieu'])) {
            $querry_option = 'SELECT * FROM "CT_KTSD"'
                . ' WHERE id=' . $data_poi_diemqt_nm[0]["ma_congtrinhktsd"];
        ...
        //         <?php
        //         if (isset($_GET['idsoHieu'])) {
        //             echo 'if (value.id == ' . $data_poi_diemqt_nm[0]["ma_tangchuanuoc"] . ') {
        //                 $("#tang_chuanuoc")
        //                     .append($("<option></option>")
        ...
        $.getJSON("../diadanh-option.php", function(diadanh) {
            ...
            $.each(diadanh, function(key, value) {
                ...
                <?php
                if (isset($_GET['idsoHieu'])) {
                    echo 'if (value.id == ' . $data_poi_diemqt_nm[0]["ma_diadanhqt"] . ') {
                        $("#diadanh")
                            .append($("<option></option>")
                                .attr("value", value.id).attr("selected", "selected").text(value.name));
                        } else {
    ...
    <script>
        $("#save_poi_diemqt_nm").click(function() {
            var soHieuDiemQT = $("#soHieuDiemQT").val();
            var madiemqt = $("#madiemqt").val();
            var congtrinh = $("#congtrinh").val();
            var diadanh = $("#diadanh").val();
            var toadoX = $("#toadoX").val();
            var toadoY = $("#toadoY").val();
            var ma_tramcu = $("#ma_tramcu").val();
            var tuanSuatBaoTri = $("#tuanSuatBaoTri").val();
            var tinhTrangHoatDong = $("#tinhTrangHoatDong").val();
            console.log(congtrinh, diadanh, madiemqt)
            // console.log(tinhTrangHoatDong)

            if (toadoX == "" || toadoY == "") {
                alert("Vui lòng nhập tọa độ!")
            } else {
                console.log(333333)
                var response_post = $.post("save-diemqt-nm.php", {
                    <?php
                    if (isset($_GET['idsoHieu'])) {
                        /*** Update Thông tin Diemdiemqt_nm ***/
                        echo 'idsoHieu:' . $_GET['idsoHieu'] . ', ' ;
                        
                    }
                    ?>
                    "soHieuDiemQT": soHieuDiemQT,
                    "congtrinh": congtrinh,
                    "diadanh": diadanh,
                    "madiemqt": madiemqt,
                    "toadoX": toadoX,
