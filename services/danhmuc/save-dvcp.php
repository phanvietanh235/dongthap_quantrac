...
if (isset($_POST['ma'])) {
    ...
    /*---- Insert Đơn vị cấp phép ----*/
    /*** Luôn Restart để tìm ID mới nhất ***/
    $max_count_select = pg_query($tiengiang_db, 'SELECT id FROM "DonViCapPhep" ORDER BY id DESC LIMIT 1');
    $max_arr = array();
    ...
    $querry_values_code = '(' . "'" . $max_count . "'" . ',' . "'" . $_POST["ten_donvi"] . "'" .
        ',' . "'" . $_POST["mota"] . "'" . ',' . "'" . $_POST["type_dvcp"] . "'" . ')';

    $querry_insert_code = 'INSERT INTO "DonViCapPhep"(
                                 "id", "name", "description", "type_dvcp") VALUES' . $querry_values_code;
