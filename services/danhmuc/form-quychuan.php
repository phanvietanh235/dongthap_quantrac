...
<?php
if (isset($_GET['ma'])) {
    $query_quychuan = 'SELECT standard.*, OT.name "LoaiHinh" FROM "Standard" standard
                            LEFT JOIN "ObservationType" OT on standard.obstypeid = OT.id
                            WHERE standard.id = ' . "'" . $_GET['ma'] . "'";

    $result_quychuan = pg_query($tiengiang_db, $query_quychuan);
    if (!$result_quychuan) {
        echo "Không có dữ liệu.\n";
        exit;
    }
    $data_quychuan = array();
    while ($row = pg_fetch_assoc($result_quychuan)) {
        $data_quychuan[] = $row;
    }
}
?>
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                                ...
                                                <form class="form-horizontal" id="fileinfo" name="fileinfo" enctype="multipart/form-data">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_quychuan" 
                                                                                value=' . '"' . $data_quychuan[0]["name"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_quychuan"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Ký hiệu quy chuẩn</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="symbol_quychuan" 
                                                                            value=' . '"' . $data_quychuan[0]["symbol"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="symbol_quychuan"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control" id="loaihinh">
                                                                <!-- DOM from Database -->
                                                            </select>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                if (is_null($data_quychuan[0]["dateoflssue"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="ngaybanhanh" 
                                                                                value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    $ngaybanhanh = explode("-", $data_quychuan[0]["dateoflssue"]);
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tổ chức ban hành</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="organization" 
                                                                            value=' . '"' . $data_quychuan[0]["organization"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="organization"/>';
                                                            }
                                                            ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_quychuan">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <a href="../../danhmuc/quychuan.php" class="btn btn-info btn-sm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Quay lại</span>
                                                    </a>
                                                </div>
    ...
    <script>
        ...
        $.getJSON("../loaihinh-option.php", function(loaihinh) {
            /* $('#loaihinh')
            ...
            $.each(loaihinh, function(key, value) {
                ...
                <?php
                if (isset($_GET['ma'])) {
                    echo 'if (value.id == ' . $data_quychuan[0]["obstypeid"] . ') {
                                $("#loaihinh")
                                    .append($("<option></option>")
    ...
    <script>
        ...
        $("#save_quychuan").click(function() {
            var ten_quychuan = $("#ten_quychuan").val();
            ...
            /*---- Update CSDL ----*/
            var response_post = $.post("save-quychuan.php", {
                <?php
                if (isset($_GET['ma'])) {
                    /*** Update Quy chuẩn ***/
                    echo 'ma:' . $_GET['ma'] . ', ';
                }
                ?> "ten_quychuan": ten_quychuan,
