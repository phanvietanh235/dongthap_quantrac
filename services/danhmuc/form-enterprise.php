...
?>
<?php
if (isset($_GET['madoanhnghiep'])) {
    $query_enterprise = 'SELECT enterprise.*, LHDN.ten "type_doanhnghiep" FROM "Enterprise" enterprise
                            LEFT JOIN "LoaiHinhDoanhNghiep" LHDN on enterprise.type = LHDN.id
                            WHERE enterprise.id = ' . "'" . $_GET['madoanhnghiep'] . "'";

    $result_enterprise = pg_query($tiengiang_db, $query_enterprise);
    if (!$result_enterprise) {
        echo "Không có dữ liệu.\n";
        exit;
    }
    $data_enterprise = array();
    while ($row = pg_fetch_assoc($result_enterprise)) {
        $data_enterprise[] = $row;
    }
}
?>
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                                ...
                                                <form class="form-horizontal" id="fileinfo" name="fileinfo" enctype="multipart/form-data">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_doanhnghiep" 
                                                                            value=' . '"' . $data_enterprise[0]["name"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_doanhnghiep"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="diachi_doanhnghiep" 
                                                                        value=' . '"' . $data_enterprise[0]["address"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="diachi_doanhnghiep"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <select class="form-control" id="loai_doanhnghiep">
                                                                <!-- DOM from Database -->
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tình trạng doanh nghiệp</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <select class="form-control input-sm" id="tinhtrang_doanhnghiep">
                                                                <?php
                                                                if ($data_enterprise[0]["active"] == 't') {
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="sodienthoai" 
                                                                        value=' . '"' . $data_enterprise[0]["phone"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="sodienthoai"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="masothue" 
                                                                        value=' . '"' . $data_enterprise[0]["tin"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="masothue"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="fax" 
                                                                        value=' . '"' . $data_enterprise[0]["fax"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="fax"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="email" 
                                                                        value=' . '"' . $data_enterprise[0]["email"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="email"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="sotaikhoan" 
                                                                        value=' . '"' . $data_enterprise[0]["accountNumber"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="sotaikhoan"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="soluong_nhanvien" 
                                                                        value=' . '"' . $data_enterprise[0]["employees"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="soluong_nhanvien"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="tongvon" 
                                                                        value=' . '"' . $data_enterprise[0]["totalInvestment"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="tongvon"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="nganhnghe" 
                                                                        value=' . '"' . $data_enterprise[0]["profession"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="nganhnghe"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="nguoidaidien" 
                                                                        value=' . '"' . $data_enterprise[0]["agent"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="nguoidaidien"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['madoanhnghiep'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="chucdanh" 
                                                                        value=' . '"' . $data_enterprise[0]["title"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="chucdanh"/>';
                                                            }
                                                            ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_enterprise">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <a href="../../danhmuc/doanhnghiep.php" class="btn btn-info btn-sm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Quay lại</span>
                                                    </a>
                                                </div>
    ...
    <script>
        /*** DOM Option Loại hình doanh nghiệp ***/
        $.getJSON("../loaihinhdoanhnghiep.php", function(loaihinhdoanhnghiep) {
            /* $('#loai_doanhnghiep')
                .append($("<option></option>")
                    .attr('value', 'none').text("--Loại doanh nghiệp--")); */
            $.each(loaihinhdoanhnghiep, function(key, value) {
                /*** Đánh dấu Option Loại doanh nghiệp được chọn ***/
                <?php
                if (isset($_GET['madoanhnghiep']) && $data_enterprise[0]["type"] != null) {
                    echo 'if (value.id == ' . $data_enterprise[0]["type"] . ') {
                            $("#loai_doanhnghiep")
                                .append($("<option></option>")
    ...
    <script>
        $("#save_enterprise").click(function() {
            ...
            var diachi_doanhnghiep = $("#diachi_doanhnghiep").val();
            var tinhtrang_doanhnghiep = $("#tinhtrang_doanhnghiep").val();
            var loai_doanhnghiep = $("#loai_doanhnghiep").val();
            var sodienthoai = $("#sodienthoai").val();
            var masothue = $("#masothue").val();
            var fax = $("#fax").val();
            var email = $("#email").val();
            var sotaikhoan = $("#sotaikhoan").val();
            var soluong_nhanvien = $("#soluong_nhanvien").val();
            var tongvon = $("#tongvon").val();
            var nganhnghe = $("#nganhnghe").val();
            var nguoidaidien = $("#nguoidaidien").val();
            var chucdanh = $("#chucdanh").val();

            /*---- Update CSDL ----*/
            var response_post = $.post("save-enterprise.php", {
                <?php
                if (isset($_GET['madoanhnghiep'])) {
                    /*** Update Doanh nghiệp ***/
                    echo 'madoanhnghiep:' . $_GET['madoanhnghiep'] . ', ';
                }
                ?> "ten_doanhnghiep": ten_doanhnghiep,
                "diachi_doanhnghiep": diachi_doanhnghiep,
                "tinhtrang_doanhnghiep": tinhtrang_doanhnghiep,
                "loai_doanhnghiep": loai_doanhnghiep,
                "sodienthoai": sodienthoai,
                "masothue": masothue,
                "fax": fax,
                "email": email,
                "sotaikhoan": sotaikhoan,
                "soluong_nhanvien": soluong_nhanvien,
                "tongvon": tongvon,
                "nganhnghe": nganhnghe,
