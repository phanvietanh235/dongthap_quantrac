...
<?php
if (isset($_GET['ma'])) {
    $query_tcn = 'SELECT * FROM "TangChuaNuoc"
                            WHERE id = ' . "'" . $_GET['ma'] . "'";

    $result_tcn = pg_query($tiengiang_db, $query_tcn);
    if (!$result_tcn) {
        echo "Không có dữ liệu.\n";
        exit;
    }
    $data_tcn = array();
    while ($row = pg_fetch_assoc($result_tcn)) {
        $data_tcn[] = $row;
    }
}
?>
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                                ...
                                                <form class="form-horizontal" id="fileinfo" name="fileinfo" enctype="multipart/form-data">
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tên tầng chứa nước</b>
                                                        </label>
                                                        <div class="col-md-10">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_tcn" 
                                                                            value=' . '"' . $data_tcn[0]["name"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_tcn"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="chieusau_mai">' .
                                                                    $data_tcn[0]["chieuSauMai"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="chieusau_mai"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="chieusau_day">' .
                                                                    $data_tcn[0]["chieuSauDay"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="chieusau_day"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Bề dày trung bình</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="beday">' .
                                                                    $data_tcn[0]["beDayTrungBinh"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="beday"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="dangchuannuoc">' .
                                                                    $data_tcn[0]["dangChuaNuoc"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="dangchuannuoc"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Mức độ chứa nước</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="mucdo_tcn">' .
                                                                    $data_tcn[0]["mucDoChuaNuoc"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="mucdo_tcn"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="thanhphan">' .
                                                                    $data_tcn[0]["thanhPhan"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="thanhphan"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="thachhoc">' .
                                                                    $data_tcn[0]["thachHoc"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="thachhoc"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Động thái mực nước</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="dongthai">' .
                                                                    $data_tcn[0]["dongThaiMucNuoc"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="dongthai"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Chất lượng tầng chứa nước</b>
                                                        </label>
                                                        <div class="col-md-10">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="chatluong_tcn">' .
                                                                    $data_tcn[0]["chatLuongTangChuaNuoc"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="chatluong_tcn"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_tcn">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <a href="../../danhmuc/tangchuanuoc.php" class="btn btn-info btn-sm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Quay lại</span>
                                                    </a>
                                                </div>
    ...
    <script>
        $("#save_tcn").click(function() {
            var ten_tcn = $("#ten_tcn").val();
            var chieusau_mai = $("#chieusau_mai").val();
            var chieusau_day = $("#chieusau_day").val();
            var beday = $("#beday").val();
            var dangchuannuoc = $("#dangchuannuoc").val();
            var mucdo_tcn = $("#mucdo_tcn").val();
            var thanhphan = $("#thanhphan").val();
            var thachhoc = $("#thachhoc").val();
            var dongthai = $("#dongthai").val();
            var chatluong_tcn = $("#chatluong_tcn").val();

            /*---- Update CSDL ----*/
            var response_post = $.post("save-tcn.php", {
                <?php
                if (isset($_GET['ma'])) {
                ...
                ?> "ten_tcn": ten_tcn,
                "chieusau_mai": chieusau_mai,
                "chieusau_day": chieusau_day,
                "beday": beday,
                "dangchuannuoc": dangchuannuoc,
                "mucdo_tcn": mucdo_tcn,
                "thanhphan": thanhphan,
                "thachhoc": thachhoc,
                "dongthai": dongthai,
                "chatluong_tcn": chatluong_tcn,
            }).done(function(data) {
                if (data == "error") {
