...
<?php
if (isset($_GET['ma'])) {
    $query_clmt = 'SELECT * FROM "Qualityindex"
                            WHERE id = ' . "'" . $_GET['ma'] . "'";

    $result_clmt = pg_query($tiengiang_db, $query_clmt);
    if (!$result_clmt) {
        echo "Không có dữ liệu.\n";
        exit;
    }
    $data_clmt = array();
    while ($row = pg_fetch_assoc($result_clmt)) {
        $data_clmt[] = $row;
    }
}
?><?php
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                                ...
                                                <form class="form-horizontal" id="fileinfo" name="fileinfo" enctype="multipart/form-data">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_clmt" 
                                                                            value=' . '"' . $data_clmt[0]["name"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_clmt"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="color_clmt" 
                                                                            value=' . '"' . $data_clmt[0]["colorcode"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="color_clmt"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="max_clmt" 
                                                                            value=' . '"' . $data_clmt[0]["abovevalue"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="max_clmt"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="min_clmt" 
                                                                            value=' . '"' . $data_clmt[0]["belowvalue"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="min_clmt"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-10">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<textarea class="form-control" id="mucdich">' .
                                                                    $data_clmt[0]["purpose"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="mucdich"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_clmt">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <a href="../../danhmuc/chatluongmt.php" class="btn btn-info btn-sm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Quay lại</span>
                                                    </a>
                                                </div>
    ...
    <script>
        $("#save_clmt").click(function() {
            var ten_clmt = $("#ten_clmt").val();
            var color_clmt = $("#color_clmt").val();
            var min_clmt = $("#min_clmt").val();
            var max_clmt = $("#max_clmt").val();
            var mucdich = $("#mucdich").val();

            /*---- Update CSDL ----*/
            var response_post = $.post("save-clmt.php", {
                <?php
                if (isset($_GET['ma'])) {
