...
<?php
if (isset($_GET['ma'])) {
    $query_lvs = 'SELECT * FROM "Basin"
                            WHERE id = ' . "'" . $_GET['ma'] . "'";

    $result_lvs = pg_query($tiengiang_db, $query_lvs);
    if (!$result_lvs) {
        echo "Không có dữ liệu.\n";
        exit;
    }
    $data_lvs = array();
    while ($row = pg_fetch_assoc($result_lvs)) {
        $data_lvs[] = $row;
    }
}
?>
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                                ...
                                                <form class="form-horizontal" id="fileinfo" name="fileinfo" enctype="multipart/form-data">
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tên lưu vực sông</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<select class="form-control input-sm" id="ten_lvs" style="width: 100%"></select>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="ten_lvs"/>';
                                                            }
                                                            ?>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="riverid" 
                                                                            value=' . '"' . $data_lvs[0]["riverid"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="riverid"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Lưu vực sông cha</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="parentriverbasinid" 
                                                                            value=' . '"' . $data_lvs[0]["parentriverbasinid"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="parentriverbasinid"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="master" 
                                                                            value=' . '"' . $data_lvs[0]["master"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="master"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="purpose" 
                                                                            value=' . '"' . $data_lvs[0]["purpose"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="purpose"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Diện tích mặt nước</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="surfaceareanwt" 
                                                                            value=' . '"' . $data_lvs[0]["surfaceareanwt"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="surfaceareanwt"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="netcapacity" 
                                                                            value=' . '"' . $data_lvs[0]["netcapacity"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="netcapacity"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="deadcapacity" 
                                                                            value=' . '"' . $data_lvs[0]["deadcapacity"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="deadcapacity"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Diện tích mặt hồ</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="risingofnormalwaterlevel" 
                                                                            value=' . '"' . $data_lvs[0]["risingofnormalwaterlevel"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="risingofnormalwaterlevel"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="deadwaterlevel" 
                                                                            value=' . '"' . $data_lvs[0]["deadwaterlevel"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="deadwaterlevel"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="beginning" 
                                                                            value=' . '"' . $data_lvs[0]["beginning"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="beginning"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="termini" 
                                                                            value=' . '"' . $data_lvs[0]["termini"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="termini"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="length" 
                                                                            value=' . '"' . $data_lvs[0]["length"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="length"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Diện tích lưu vực sông</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="riverbasinarea" 
                                                                            value=' . '"' . $data_lvs[0]["riverbasinarea"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="riverbasinarea"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Lưu lượng trung bình</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="averageflowrate" 
                                                                            value=' . '"' . $data_lvs[0]["averageflowrate"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="averageflowrate"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="capacity" 
                                                                            value=' . '"' . $data_lvs[0]["capacity"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="capacity"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Mực nước bình thường</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="normalwaterlevel" 
                                                                            value=' . '"' . $data_lvs[0]["normalwaterlevel"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="normalwaterlevel"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['ma'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="standard" 
                                                                            value=' . '"' . $data_lvs[0]["standard"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="standard"/>';
                                                            }
                                                            ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_lvs">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Lưu thông tin</span>
                                                    </a>
                                                    <a href="../../danhmuc/luuvucsong.php" class="btn btn-info btn-sm">
                                                        <i class="ti-save-alt pdd-right-5"></i>
                                                        <span>Quay lại</span>
                                                    </a>
                                                </div>
    ...
    <script>
        ...
        if (isset($_GET['ma'])) {
            ...
            $basin_selected = [];
            while ($row = pg_fetch_assoc($result)) {
                $basin_selected[] = array(
                    "id" => $row['id'],
                    "text" => $row['name']
                );
            }

            echo '$("#ten_lvs").select2("trigger", "select", {
                            data: ' .
                '{ id:' . $basin_selected[0]["id"] . ',' .
                'text:' . "'" . $basin_selected[0]["text"] . "'" .
                ',}' . '});';
        }
        ?>
    </script>
    ...
    <script>
        $("#save_lvs").click(function() {
            var riverid = $("#riverid").val();
            var ten_lvs = $("#ten_lvs").val();
            var parentriverbasinid = $("#parentriverbasinid").val();
            var master = $("#master").val();
            var purpose = $("#purpose").val();
            var surfaceareanwt = $("#surfaceareanwt").val();
            var netcapacity = $("#netcapacity").val();
            var deadcapacity = $("#deadcapacity").val();
            var risingofnormalwaterlevel = $("#risingofnormalwaterlevel").val();
            var deadwaterlevel = $("#deadwaterlevel").val();
            var beginning = $("#beginning").val();
            var termini = $("#termini").val();
            var length = $("#length").val();
            var riverbasinarea = $("#riverbasinarea").val();
            var averageflowrate = $("#averageflowrate").val();
            var capacity = $("#capacity").val();
            var normalwaterlevel = $("#normalwaterlevel").val();
            var standard = $("#standard").val();

            /*---- Update CSDL ----*/
            var response_post = $.post("save-lvs.php", {
                <?php
                if (isset($_GET['ma'])) {
                    /*** Update Lưu vực sông ***/
                    echo 'ma:' . $_GET['ma'] . ', ';
                ...
                ?> "riverid": riverid,
                "ten_lvs": ten_lvs,
                "parentriverbasinid": parentriverbasinid,
                "master": master,
                "purpose": purpose,
                "surfaceareanwt": surfaceareanwt,
                "netcapacity": netcapacity,
                "deadcapacity": deadcapacity,
                "risingofnormalwaterlevel": risingofnormalwaterlevel,
                "deadwaterlevel": deadwaterlevel,
                "beginning": beginning,
                "termini": termini,
                "length": length,
                "riverbasinarea": riverbasinarea,
