...
?>
<?php
$querry_feat = 'SELECT * FROM feat_ktsd_td WHERE idgieng = ' . "'" . $_POST["idgieng"] . "'";
...
$content .= '<div class="col-lg-12 text-right" style="margin-top: 7px">
        <a href="services/giamsat-tnn/giamsat-info.php?idpoi=' . $data[0]["idgieng"] . '&type=td&name=' . $data[0]["soHieuGiengTD"] .
    '" style="margin-top: 7px; float: left" class="control-label btn btn-xs btn-success" target="_blank">
        <i class="fa fa-table"></i>
        <b>Xem dữ liệu giám sát</b>
        </a>
        <a href="services/ktsd-td/form-poi-ktsd-td.php?macongtrinh=' . $data[0]["macongtrinh"] . '&idgieng=' . $data[0]["idgieng"] .
