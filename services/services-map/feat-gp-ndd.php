...
$content .= '<div class="col-lg-12">
        <input class="form-control input-sm" disabled value="' . $data[0]["soGiayPhepNDD"] . '"/>' .
    '</div>';
...
$content .= '<div class="col-lg-12 text-right" style="margin-top: 7px">
        <a href="services/ktsd-ndd/form-gp-ndd.php?macongtrinh=' . $data[0]["macongtrinh"] . '&idgp=' . $data[0]["idgp"] .
