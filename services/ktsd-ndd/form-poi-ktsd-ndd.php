...
if (isset($_GET["idgieng"])) {
    $querry_poi_ktsd_ndd = 'SELECT diemktsd_ndd.*, tangchuanuoc.name "TangChuaNuoc" FROM "DiemKTSD_NDD" diemktsd_ndd
                                ...
                                WHERE ma_congtrinhktsd =' . "'" . $macongtrinh . "'" . "AND diemktsd_ndd.id =" . "'" . $_GET["idgieng"] . "'";
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                                ...
                                                <form class="form-horizontal">
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Số hiệu điểm khai thác</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="sohieugieng" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["soHieuGieng"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="sohieugieng"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["toaDoX"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoX"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["toaDoY"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="toadoY"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Chiều sâu giếng từ</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="chieuSau_tu" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["chieuSauGiengTu"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="chieuSau_tu"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Chiều sâu giếng đến</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="chieuSau_den" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["chieuSauGiengDen"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="chieuSau_den"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Chiều sâu mực nước tĩnh</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="mn_tinh" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["chieuSauMNTinh"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="mn_tinh"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Chiều sâu mực nước động</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="mn_dong" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["chieuSauMNDongLonNhat"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="mn_dong"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="chedo_kt" 
                                                                    value=' . '"' . $data_poi_ktsd_ndd[0]["cheDoKhaiThac"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="chedo_kt"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Tình trạng giếng</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <select class="form-control input-sm" id="tinhtrang_gieng">
                                                                <?php
                                                                if ($data_poi_ktsd_ndd[0]["tinhTrangGieng"] == 't') {
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                if (is_null($data_poi_ktsd_ndd[0]["vungBHVS"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="vung_baoho" 
                                                                        value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    echo '<input type="text" class="form-control input-sm" id="vung_baoho" 
                                                                        value=' . '"' . $data_poi_ktsd_ndd[0]["vungBHVS"] . '"' . '/>';
                                                                }
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="vung_baoho"/>';
                                                            }
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-10">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<textarea class="form-control" id="ketcau_giengkhoan">' .
                                                                    $data_poi_ktsd_ndd[0]["ketCauGiengKhoan"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="ketcau_giengkhoan"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Mô tả vùng bảo hộ</b>
                                                        </label>
                                                        <div class="col-md-10">
                                                            <?php
                                                            if (isset($_GET['idgieng'])) {
                                                                echo '<textarea class="form-control" id="mota_vungbaoho">' .
                                                                    $data_poi_ktsd_ndd[0]["moTaVungBHVS"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="mota_vungbaoho"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_poi_ktsd_ndd">
    ...
    <script>
        ...
        $.getJSON("../tangchuanuoc-option.php", function(tang_chuanuoc) {
            ...
            $.each(tang_chuanuoc, function(key, value) {
                ...
                <?php
                if (isset($_GET['idgieng'])) {
                    echo 'if (value.id == ' . $data_poi_ktsd_ndd[0]["ma_tangchuanuoc"] . ') {
                            $("#tang_chuanuoc")
                                .append($("<option></option>")
    ...
    <script>
        $("#save_poi_ktsd_ndd").click(function() {
            var sohieugieng = $("#sohieugieng").val();
            var tang_chuanuoc = $("#tang_chuanuoc").val();
            var toadoX = $("#toadoX").val();
            var toadoY = $("#toadoY").val();
            var chieuSau_tu = $("#chieuSau_tu").val();
            var chieuSau_den = $("#chieuSau_den").val();
            var mn_tinh = $("#mn_tinh").val();
            var mn_dong = $("#mn_dong").val();
            var chedo_kt = $("#chedo_kt").val();
            var tinhtrang_gieng = $("#tinhtrang_gieng").val();
            var vung_baoho = $("#vung_baoho").val();
            var mota_vungbaoho = $("#mota_vungbaoho").val();
            var ketcau_giengkhoan = $("#ketcau_giengkhoan").val();

            if (toadoX == "" || toadoY == "") {
                alert("Vui lòng nhập tọa độ!")
            } else {
                var response_post = $.post("save-poi-ktsd-ndd.php", {
                    <?php
                    if (isset($_GET['idgieng'])) {
                        /*** Update Thông tin DiemKTSD_NDD ***/
                        echo 'id_gieng:' . $_GET['idgieng'] . ', ' .
                            'macongtrinh:' . $macongtrinh . ', ';
                    } else {
                        /*** Insert Thông tin DiemKTSD_NDD ***/
                        echo 'macongtrinh:' . $macongtrinh . ', ';
                    }
                    ?> "sohieugieng": sohieugieng,
                    "tang_chuanuoc": tang_chuanuoc,
                    "toadoX": toadoX,
                    "toadoY": toadoY,
                    "chieuSau_tu": chieuSau_tu,
                    "chieuSau_den": chieuSau_den,
                    "mn_tinh": mn_tinh,
                    "mn_dong": mn_dong,
                    "chedo_kt": chedo_kt,
                    "tinhtrang_gieng": tinhtrang_gieng,
                    "vung_baoho": vung_baoho,
                    "mota_vungbaoho": mota_vungbaoho,
                    "ketcau_giengkhoan": ketcau_giengkhoan
                }).done(function(data) {
                    if (data == "error") {
