...
if (isset($_GET["idtiencq"])) {
    $querry_tiencq_ndd = 'SELECT tiencq_ndd.*, thongtincp_ndd."soGiayPhepNDD" FROM "TienCapQuyen_NDD" tiencq_ndd
                                LEFT JOIN "ThongTinCP_NDD" thongtincp_ndd on tiencq_ndd.ma_giayphepndd = thongtincp_ndd.id
                                WHERE tiencq_ndd.id =' . "'" . $_GET["idtiencq"] . "'";
    ...
    /*** Process soTienNopHangNam ***/
    $tiennop_hangnam = explode(";", $data_tiencq_ndd[0]["soTienNopHangNam"]);
    $tien_hangnam_arr = array();
    foreach ($tiennop_hangnam as $key => $value) {
        $tien_hangnam_arr[] = array("sotien_hangnam" => $value);
    }

    $final_tien_hangnam = json_encode($tien_hangnam_arr);
} else {
    $final_tien_hangnam = json_encode([]);
}
?>
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold">
                                            THÔNG TIN TIỀN CẤP QUYỀN KHAI THÁC SỬ DỤNG NƯỚC DƯỚI ĐẤT
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <select class="form-control" id="sogiayphep">
                                                                <!-- DOM from Database -->
                                                            </select>
                                                        </div>
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Số quyết định phê duyệt</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdpd" 
                                                                    value=' . '"' . $data_tiencq_ndd[0]["quyetDinhPheDuyetTCQ"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdpd"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Ngày ban hành quyết định</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idtiencq'])) {
                                                                if (is_null($data_tiencq_ndd[0]["ngayBanHanhQDPD"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="ngay_banhanh" 
                                                                            value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    $ngaybanhanh = explode("-", $data_tiencq_ndd[0]["ngayBanHanhQDPD"]);
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="tongtiennop" 
                                                                    value=' . '"' . $data_tiencq_ndd[0]["tongTienNop"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="tongtiennop"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="pa_nop" 
                                                                    value=' . '"' . $data_tiencq_ndd[0]["phuongAnNop"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="pa_nop"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="thoigian_nop" 
                                                                    value=' . '"' . $data_tiencq_ndd[0]["thoiGianNop"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="thoigian_nop"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Thông báo phê duyệt</b>
                                                        </label>
                                                        <div class="col-md-4">
                                                            <?php
                                                            if (isset($_GET['idtiencq'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="thongbao" 
                                                                        value=' . '"' . $data_tiencq_ndd[0]["thongBaoPheDuyet"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="thongbao"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt" style="margin-bottom: 0">
                                                        <div class="text-right col-md-8" style="margin: auto">
                                                            <a class="btn btn-info btn-sm" id="add_tien_hangnam" style="color:#000; border-radius: 0; border-color: #93c5ff;
                                                               margin-right: 1px; background-color: #93c5ff;">
                                                                <i class="fa fa-plus pdd-right-5"></i>
                                                                <span style="font-weight: bold">Thêm tiền nộp</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <div class="col-md-8" style="margin: auto">
                                                            <table id="tien_hangnam" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_tiencq_ndd">
    ...
    <script>
        /*** DOM option số giấy phép theo ma_congtrinhktsd ***/
        <?php
        $script = '$.getJSON("../thongtingp-ndd-option.php?macongtrinh=' . $macongtrinh . '", function (gpndd_option) {';
        /* $script.= '$("#sogiayphep")
                .append($("<option></option>")
                    .attr("value", "none").text("--Chọn giấy phép--")); */
        $script .= '$.each(gpndd_option, function (key, value) {';

        if (isset($_GET['idtiencq'])) {
            $script .= 'if (value.id == ' . $data_tiencq_ndd[0]["ma_giayphepndd"] . ') {
                    $("#sogiayphep")
                        .append($("<option></option>")
                            .attr("value", value.id).attr("selected", "selected").text(value.sogp_ndd));
                    } else {
                        $("#sogiayphep")
                            .append($("<option></option>")
                                .attr("value", value.id).text(value.sogp_ndd));
                    }';
        } else {
            $script .= '$("#sogiayphep")
                    .append($("<option></option>")
    ...
    <!-- DOM Tabulator soTienNopHangNam -->
    <script>
        var delete_rowButton = function(cell, formatterParams, onRendered) {
            return '<i class="fa fa-trash-o font-size-14 text-danger"></i>';
        };

        var table = new Tabulator("#tien_hangnam", {
            layout: "fitColumns",
            columns: [{
                    title: "Kỳ nộp",
                    formatter: "rownum",
        ...
        <?php
        echo 'table.setData(' . $final_tien_hangnam . '); ';
        ?>

        /*** Add Row Số tiền hằng năm ***/
        document.getElementById("add_tien_hangnam").addEventListener("click", function() {
            table.addRow({});
        });
    </script>

    <script>
        $('#ngay_banhanh').datepicker({
            language: "vi",
            format: "dd/mm/yyyy"
        });

        $("#save_tiencq_ndd").click(function() {
            var ma_sogiayphep = $("#sogiayphep").val();
            var so_qdpd = $("#so_qdpd").val();
            var ngay_banhanh = $("#ngay_banhanh").val();
            var tongtiennop = $("#tongtiennop").val();
            var pa_nop = $("#pa_nop").val();
            var thoigian_nop = $("#thoigian_nop").val();
            var thongbao = $("#thongbao").val();
            /*** Process soTienNopHangNam ***/
            var myTable = Tabulator.prototype.findTable("#tien_hangnam")[0];
            var tien_hangnam_arr = myTable.getData();
            var tien_hangnam_str = "";
            tien_hangnam_arr.forEach(val => tien_hangnam_str += val.sotien_hangnam + ";");
            tien_hangnam = tien_hangnam_str.slice(0, -1);

            var response_post = $.post("save-tiencq-ndd.php", {
                <?php
                if (isset($_GET['idtiencq'])) {
                    /*** Update ThongtinCP_NDD ***/
                    echo 'id_tiencq:' . $_GET['idtiencq'] . ', ';
                }
                ?> "ma_sogiayphep": ma_sogiayphep,
                "so_qdpd": so_qdpd,
                "ngay_banhanh": ngay_banhanh,
                "tongtiennop": tongtiennop,
                "pa_nop": pa_nop,
                "thoigian_nop": thoigian_nop,
                "thongbao": thongbao,
                "tien_hangnam": tien_hangnam,
            }).done(function(data) {
                if (data == "error") {
