...
<li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="../../baocao-thongke/thvp-dacap.php" class="">Số lượng thvp đã cấp</a>
                                </li>
                                <li>
...
<a href="../../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold">
                                            TÌNH HÌNH VI PHẠM KHAI THÁC SỬ DỤNG NƯỚC DƯỚI ĐẤT
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form class="form-horizontal">
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Số quyết định xử phạt</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdxp" 
                                                                        value=' . '"' . $data_thvp_ndd[0]["quyetDinhXP"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="so_qdxp"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <select class="form-control" id="doanhnghiep">
                                                                <!-- DOM from Database -->
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idthvp'])) {
                                                                if (is_null($data_thvp_ndd[0]["ngayXP"])) {
                                                                    echo '<input type="text" class="form-control input-sm" id="ngayxuphat" 
                                                                        value=' . '"' . '"' . '/>';
                                                                } else {
                                                                    $ngayXP = explode("-", $data_thvp_ndd[0]["ngayXP"]);
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="donvi_xp" 
                                                                    value=' . '"' . $data_thvp_ndd[0]["donViXP"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="donvi_xp"/>';
                                                            }
                                                            ?>
                                                        ...
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Hình thức xử phạt</b>
                                                        </label>
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="hinhthuc_xp" 
                                                                    value=' . '"' . $data_thvp_ndd[0]["hinhThucXP"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="hinhthuc_xp"/>';
                                                            }
                                                            ?>
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-2 control-label">
                                                            <b>Nội dung xử phạt</b>
                                                        </label>
                                                        <div class="col-md-10">
                                                            <?php
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<textarea class="form-control" id="noidung_xuphat">' .
                                                                    $data_thvp_ndd[0]["noiDungXP"] . '</textarea>';
                                                            } else {
                                                                echo '<textarea class="form-control" id="noidung_xuphat"></textarea>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-2">
                                                            <?php
                                                            if (isset($_GET['idthvp'])) {
                                                                echo '<input type="text" class="form-control input-sm" id="tien_xp" 
                                                                    value=' . '"' . $data_thvp_ndd[0]["soTienXP"] . '"' . '/>';
                                                            } else {
                                                                echo '<input type="text" class="form-control input-sm" id="tien_xp"/>';
                                                            }
                                                            ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-success btn-sm" id="save_thvp_ndd">
    ...
    <script>
        ...
        $.getJSON("../doanhnghiep.php", function(doanhnghiep) {
            /* $('#doanhnghiep')
                .append($("<option></option>")
                    .attr('value', 'none').text("--Lựa chọn doanh nghiệp--")); */
            $.each(doanhnghiep, function(key, value) {
                /*** Đánh dấu Option Đơn vị cấp phép được chọn ***/
                <?php
                if (isset($_GET['idthvp'])) {
                    echo 'if (value.id == ' . $data_thvp_ndd[0]["ma_doanhnghiep"] . ') {
                        $("#doanhnghiep")
                            .append($("<option></option>")
    ...
    <script>
        $('#ngayxuphat').datepicker({
            language: "vi",
            format: "dd/mm/yyyy"
        });

        $("#save_thvp_ndd").click(function() {
            var so_qdxp = $("#so_qdxp").val();
            var doanhnghiep = $("#doanhnghiep").val();
            var ngayxuphat = $("#ngayxuphat").val();
            var donvi_xp = $("#donvi_xp").val();
            var hinhthuc_xp = $("#hinhthuc_xp").val();
            var noidung_xuphat = $("#noidung_xuphat").val();
            var tien_xp = $("#tien_xp").val();

            var response_post = $.post("save-thvp-ndd.php", {
                <?php
                if (isset($_GET['idthvp'])) {
                    /*** Update TinhHinhXuPhat_NDD ***/
                    echo 'id_thvp:' . $_GET['idthvp'] . ', ' .
                        'macongtrinh:' . $macongtrinh . ', ';
                } else {
                    /*** Insert TinhHinhXuPhat_NDD ***/
                    echo 'macongtrinh:' . $macongtrinh . ', ';
                }
                ?> "so_qdxp": so_qdxp,
                "doanhnghiep": doanhnghiep,
                "ngayxuphat": ngayxuphat,
                "donvi_xp": donvi_xp,
                "hinhthuc_xp": hinhthuc_xp,
                "noidung_xuphat": noidung_xuphat,
                "tien_xp": tien_xp,
            }).done(function(data) {
                if (data == "error") {
