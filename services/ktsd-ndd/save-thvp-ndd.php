...
if (isset($_POST['id_thvp'])) {
    ...
    $query = 'UPDATE "TinhHinhViPham_NDD" ';
    ...
    /*---- Insert TinhHinhViPham_NDD ----*/
    /*** Luôn Restart để tìm ID mới nhất ***/
    $max_count_select = pg_query($tiengiang_db, 'SELECT id FROM "TinhHinhViPham_NDD" ORDER BY id DESC LIMIT 1');
    $max_arr = array();
    ...
    $querry_values_code = '(' . "'" . $max_count . "'" . ',' . "'" . $_POST["doanhnghiep"] . "'" .
        ...
        ',' . "'" . $_POST["noidung_xuphat"] . "'" . ',' . $tien_xp . ')';

    $querry_insert_code = 'INSERT INTO "TinhHinhViPham_NDD"(
