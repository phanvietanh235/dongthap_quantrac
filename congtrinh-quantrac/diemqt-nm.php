...
<body>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>DANH SÁCH ĐIỂM QUAN TRẮC NƯỚC MẶT</b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="soHieuDiemQT" placeholder="" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="ma_tramcu" placeholder="" type="text">
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="diachi_ct" placeholder="" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                            <b>Cơ sở khai thác sử dụng</b>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="coso_sanxuat" placeholder="" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <!-- <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <a href="#" class="btn btn-info btn-sm" id="search_list_diemqt_nm">
                                                                <i class="ti-search pdd-right-5"></i>
                                                                <span>Tìm kiếm</span>
                                                            </a>
                                                            <!-- <a href="#" class="btn btn-success btn-sm" id="export_list_diemqt_nm">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-list-diemqt-nm" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-list-diemqt-nm">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="list_diemqt_nm_table" class="table table-sm table-hover table-bordered">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="list-ctkt text-right">
                                                    <a href="#" class="btn btn-info btn-sm" id="create_diemqt_nm">
                                                        <i class="ti-plus pdd-right-5"></i>
                                                        <span>Thêm mới</span>
                                                    </a>
                                                    <a href="#" class="btn btn-danger btn-sm" id="delete_create_diemqt_nm">
                                                        <i class="ti-eraser pdd-right-5"></i>
                                                        <span>Xóa</span>
                                                    </a>
                                                    <a href="#" class="btn btn-success btn-sm" id="export_create_diemqt_nm">
                                                        <i class="ti-export pdd-right-5"></i>
    ...
    <script src="js/diemqt-nm.js"></script>
