                ...
                <div class="side-nav-inner">
                    ...
                    <ul class="side-nav-menu scrollable">
                        ...
                        <li class="nav-item dropdown open">
                            ...
                            <ul class="dropdown-menu">
                                <!--<li>
                                    <a href="ktsd-nuocmat.php" class="">KTSD Nước mặt</a>
                                </li>
                                <li>
                                    <a href="ktsd-nuocduoidat.php" class="">KTSD Nước dưới đất</a>
                                </li>-->
                                <li>
                                    <a href="nguonxathai.php" class="">Nguồn xả thải</a>
                                </li>
                                <!--<li>
                                    <a href="thamdo.php" class="">CT Thăm dò Nước dưới đất</a>
                                </li>
                                <li>
                                    <a href="giamsatnuoc.php" class="">Giám sát tài nguyên nước</a>
                                </li>-->
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 style="text-transform: uppercase; color: #0f9aee">
                                    ...
                                    <b>Thông tin công trình - Thêm mới</b>
                                </h4>
                                <span style="color: red; text-align: right"><i>(*: Bắt buộc)</i></span>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form class="form-horizontal" method="post" id="info_ctkt_form" enctype="multipart/form-data">
                                            <div class="form-group row list-ctkt">
                                                <label style="margin-top: 7px" class="col-md-2 control-label">
                                                    <b>Tên công trình <span style="color: red">*</span></b>
                                                </label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group row list-ctkt">
                                                <label style="margin-top: 7px" class="col-md-2 control-label">
                                                    <b>Địa chỉ công trình <span style="color: red">*</span></b>
                                                </label>
                                                <div class="col-md-10">
                                                    <input class="form-control input-sm"
                                            ...
                                            <div class="form-group row list-ctkt">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control" id="quanhuyen_modal"></select>
                                                </div>
                                                <label style="margin-top: 7px" class="col-md-2 control-label">
                                                    <b>Phường/Xã <span style="color: red">*</span></b>
                                                </label>
                                                <div class="col-md-4">
                                                    <select class="form-control" id="phuongxa_modal">
                            ...
                            <div class="modal-footer">
                                <input type="submit" name="add_info_ctkt" id="add_info_ctkt" class="btn btn-success" value="Thêm mới" />
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>DANH SÁCH CÔNG TRÌNH KHAI THÁC SỬ DỤNG NƯỚC DƯỚI ĐẤT</b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="name_ct" placeholder="Tên công trình" type="text">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="mucdich_kt" placeholder="Mục đích KT" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input class="form-control input-sm" id="tongsogieng" placeholder="Tổng số giếng" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="thoihan_ktsd" placeholder="Thời hạn KTSD" type="text">
                                                        </div>
                                                    </div> -->
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="doanhnghiep" placeholder="Doanh nghiệp" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="sogiayphep" placeholder="Số giấy phép" type="text">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                            <b>Tình trạng giếng KT</b>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <select class="form-control" id="status_gieng_ndd">
                                                                <option value="all" selected>Toàn bộ</option>
                                                                <option value="true">Còn hoạt động</option>
                                                                <option value="false">Đã trám lấp</option>
                                                            </select>
                                                        </div>
                                                    </div> -->
                                                </form>
                                            ...
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="diachi_ct" placeholder="Vị trí KT" type="text">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="chedo_kt" placeholder="Chế độ khai thác" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <input class="form-control input-sm" id="tong_llkt" placeholder="Tổng LLKT" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="tangchuanuoc" multiple="multiple" style="width: 100%">
                                                            </select>
                                                        </div>
                                                    </div> -->
                                                    <div class="form-group row list-ctkt">
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="coso_sanxuat" placeholder="Cơ sở sản xuất" type="text">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group row list-ctkt">
                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="phamvi_capnuoc" placeholder="Phạm vi cấp nước" type="text">
                                                        </div>
                                                    </div> -->
                                                    <div class="form-group row list-ctkt">
                                                        <!-- <label style="margin-top: 7px" class="col-md-4 control-label">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control" id="status_list_ctkt_ndd">
                                                                <option value="all" selected>Toàn bộ</option>
                                                        ...
                                                        <div class="col-md-8">
                                                            <input class="form-control input-sm" id="nam_xd" placeholder="Năm xây dựng" type="text">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row list-ctkt">
                                                        <div class="col-md-12">
                                                            <a href="#" class="btn btn-success btn-sm float-right" id="export_list_ctkt_ndd">
                                                                <i class="fa fa-file-excel-o pdd-right-5"></i>
                                                                <span>Tải về</span>
                                                            </a>
                                                            <a href="#" class="btn btn-info btn-sm float-right" id="search_list_ctkt_ndd">
                                                                <i class="ti-search pdd-right-5"></i>
                                                                <span>Tìm kiếm</span>
                                                            </a>
                                                            <a href="#" class="btn btn-outline-info btn-sm float-right" id="add_ctkt_ndd">
                                            ...
                                            <div class="col-md-12">
                                                <div class="tab-info">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a href="#nav-list-ctkt" class="nav-link active" role="tab" data-toggle="tab">
                                                ...
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-list-ctkt">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="list_ctkt_ndd_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="js/ktsd-nuocduoidat.js"></script>
