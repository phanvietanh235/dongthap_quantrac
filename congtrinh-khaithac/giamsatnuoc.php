...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                                ...
                                <div class="card">
                                    <div class="card-block pdd-vertical-15 pdd-horizon-15">
                                        <h4 class="card-title text-bold">
                                            GIÁM SÁT CÔNG TRÌNH KHAI THÁC TÀI NGUYÊN NƯỚC
                                        </h4>
                                        <div class="row">
                                                        ...
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            <li class="nav-item">
                                                                <a href="#nav-tabs-1" class="nav-link active" role="tab" data-toggle="tab">
                                                                    <i class="icon-search4 pdd-right-10"></i> Tra cứu thông tin giám sát công trình
                                                                </a>
                                                            </li>
                                                            <!-- <li class="nav-item">
                                                                <a href="#nav-tabs-2" class="nav-link" role="tab" data-toggle="tab">
                                                                    <i class="icon-alert pdd-right-10"></i> Danh sách giám sát công trình vượt ngưỡng
                                                                </a>
                                                            </li> -->
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-tabs-1">
                                                        <div class="row">
                                                                ...
                                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                                    <div class="form-group row list-ctkt">
                                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                                            <b>Số hiệu giếng/điểm</b>
                                                                        </label>
                                                                        <div class="col-md-8">
                                                                            <input class="form-control input-sm" id="sohieu" placeholder="Số hiệu giếng/điểm" type="text">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row list-ctkt">
                                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                                    ...
                                                                    <div class="form-group row list-ctkt">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            ...
                                                                            <option value="none">--Lựa chọn Phường/Xã--</option>
                                                                        </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row list-ctkt">
                                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                                        <b>Loại công trình khai thác</b>
                                                                    </label>
                                                                        <div class="col-md-8">
                                                                            <select class="form-control" id="ctkt">
                                                                        </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row list-ctkt">
                                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                                        <b>Tình trạng điểm/giếng</b>
                                                                    </label>
                                                                        <div class="col-md-8">
                                                                            <select class="form-control" id="tinhtrang_giengdiem">
                                                                            <option value="none">--Lựa chọn tình trạng--</option>
                                                                            <option value="true">Còn hoạt động</option>
                                                                            <option value="false">Không hoạt động/Đã trám lấp</option>
                                                                        </select>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            <div class="col-md-6">
                                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                                    <div class="form-group row list-ctkt">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input class="form-control input-sm" id="ten_ct" placeholder="Tên công trình" type="text">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row list-ctkt">
                                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <input class="form-control input-sm" id="diachi_ct" placeholder="Địa chỉ công trình" type="text">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row list-ctkt">
                                                                        <label style="margin-top: 7px" class="col-md-4 control-label">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <select id="basin_option" style="width: 100%">
                                                                        </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row list-ctkt">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <select id="tangchuanuoc" style="width: 100%">
                                                                        </select>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            <div class="col-md-12 text-right">
                                                                <a href="#" class="btn btn-info btn-sm" id="search_station_ctkt">
                                                                    <i class="ti-search pdd-right-5"></i>
                                                                    <span>Tìm kiếm</span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <!-- Kết quả tìm kiếm các giếng/điểm khai thác -->
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="pill-success">
                                                                    <ul class="nav nav-pills" role="tablist" id="tab_giamsat">
                                                                        <li class="nav-item">
                                                                            <a href="#nav-list-ctkt" class="nav-link active" role="tab" data-toggle="tab">
                                                                                <i class="icon-station pdd-right-10"></i> Thông tin các điểm/giếng giám sát tự động
                                                                            </a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="#nav-list-ctkt-2" class="nav-link" role="tab" data-toggle="tab">
                                                                                <i class="fa fa-industry pdd-right-10"></i> Thông tin các điểm/giếng giám sát thủ công
                                                                            </a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                                    ...
                                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-list-ctkt">
                                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                                            <div class="table-overflow">
                                                                                <table id="list_station_ctkt" class="table table-sm table-hover table-bordered">
                                                                                    <!-- DOM after Process Data -->
                                                                                </table>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div role="tabpanel" class="tab-pane fade" id="nav-list-ctkt-2">
                                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                                            <div class="table-overflow">
                                                                                <table id="list_station_ctkt_2" class="table table-sm table-hover table-bordered">
                                                                                    <!-- DOM after Process Data -->
                                                                                </table>
                                                                            </div>
                                                                        </div>
    ...
    <script src="js/giamsatnuoc.js"></script>
