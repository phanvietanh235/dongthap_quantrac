...
<a href="../HDSD_QuanTracDongThap.docx">Hướng dẫn sử dụng</a>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">
                                            <b>DANH SÁCH CÔNG TRÌNH KHAI THÁC SỬ DỤNG NƯỚC MẶT</b>
                                        </h4>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <form class="form-horizontal mrg-top-10 pdd-right-30">
                                                    ...
                                                    <div class="form-group row list-ctkt">
                                                        <div class="col-md-12">
                                                            <a href="#" class="btn btn-success btn-sm float-right" id="export_list_ctkt_nm">
                                                                <i class="fa fa-file-excel-o pdd-right-5"></i>
                                                                <span>Tải về</span>
                                                            </a>
                                                            <a href="#" class="btn btn-info btn-sm float-right" id="search_list_ctkt_nm">
                                                                <i class="ti-search pdd-right-5"></i>
                                                                <span>Tìm kiếm</span>
                                                            </a>
                                                            <a href="#" class="btn btn-outline-info btn-sm float-right" id="add_ctkt_nm">
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade in active" id="nav-list-ctkt">
                                                        <div class="pdd-horizon-15 pdd-vertical-20">
                                                            <div class="table-overflow">
                                                                <table id="list_ctkt_nm_table" class="table table-sm table-hover table-bordered">
    ...
    <script src="js/ktsd-nuocmat.js"></script>
